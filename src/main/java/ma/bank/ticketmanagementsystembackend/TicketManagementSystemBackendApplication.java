    ...
    CommandLineRunner commandLineRunner(
        ...
        return args -> {
            if (userService.getAllUsers().isEmpty()) {
                ...
                // ========== ADMINS ==========
                AppUserDTO aymane = userService.createUserInternal(
                        AppUser.builder()
                                .name("Aymane Jemmaa")
                ...
                AppUserDTO adam = userService.createUserInternal(
                        AppUser.builder()
                                .name("Adam Tayan")
                ...
                AppUserDTO sarah = userService.createUserInternal(
                        AppUser.builder()
                                .name("Sarah Martinez")
                ...
                // ========== MANAGERS ==========
                AppUserDTO manager1 = userService.createUserInternal(
                        AppUser.builder()
                                .name("Emily Stone")
                ...
                AppUserDTO manager2 = userService.createUserInternal(
                        AppUser.builder()
                                .name("Ryan Gosling")
                ...
                AppUserDTO manager3 = userService.createUserInternal(
                        AppUser.builder()
                                .name("Mia Goth")
                                .email("mia@gmail.com")
                ...
                AppUserDTO manager4 = userService.createUserInternal(
                        AppUser.builder()
                                .name("Omar Hassan")
                ...
                AppUserDTO manager5 = userService.createUserInternal(
                        AppUser.builder()
                                .name("Fatima Zahra")
                ...
                AppUserDTO john = userService.createUserInternal(
                        AppUser.builder()
                                .name("John Doe")
                ...
                AppUserDTO karim = userService.createUserInternal(
                        AppUser.builder()
                                .name("Karim Benzema")
                ...
                AppUserDTO amina = userService.createUserInternal(
                        AppUser.builder()
                ...
                // ========== USERS - Atlas Telecom ==========
                AppUserDTO jane = userService.createUserInternal(
                        AppUser.builder()
                                .name("Jane Smith")
                ...
                AppUserDTO youssef = userService.createUserInternal(
                        AppUser.builder()
                                .name("Youssef Tahiri")
                ...
                AppUserDTO laila = userService.createUserInternal(
                        AppUser.builder()
                                .name("Laila Bennani")
                ...
                // ========== USERS - Binarios ==========
                AppUserDTO mike = userService.createUserInternal(
                        AppUser.builder()
                                .name("Mike Johnson")
                ...
                AppUserDTO sofia = userService.createUserInternal(
                        AppUser.builder()
                                .name("Sofia Alami")
                ...
                AppUserDTO mehdi = userService.createUserInternal(
                        AppUser.builder()
                                .name("Mehdi Fassi")
                ...
                // ========== USERS - Medina Tech ==========
                AppUserDTO hassan = userService.createUserInternal(
                        AppUser.builder()
                                .name("Hassan Idrissi")
                ...
                AppUserDTO nadia = userService.createUserInternal(
                        AppUser.builder()
                                .name("Nadia Berrada")
                ...
                AppUserDTO rachid = userService.createUserInternal(
                        AppUser.builder()
                                .name("Rachid Tazi")
                ...
                AppUserDTO samira = userService.createUserInternal(
                        AppUser.builder()
                                .name("Samira Chakir")
